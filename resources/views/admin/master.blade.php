...
<head>
    ...
    <meta name="description" content="Project Laravel By Minh IT">
    <meta name="author" content="Cao Khả Minh">
    <title>Dashboard Shop Cỏ May</title>
    ...
    <script type="text/javascript">
        var baseURL = "{!! url('/') !!}"; // khai báo baseUrl là đường dẫn gốc : localhost/<tên project>/ đường dẫn cấu hình trong file func_ckfinder.js
    </script>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        Chào: {{ Auth::user()->username }}  <i class="fa fa-caret-down"></i>
                    </a>
...
{{-- My script --}}
<script src="{{ url('public/admin/js/my_js.js') }}"></script>
